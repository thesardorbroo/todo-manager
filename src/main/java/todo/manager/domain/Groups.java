...
public class Groups implements Serializable {
    ...
    public void setTasks(Set<Task> tasks) {
        if (this.tasks != null) {
            this.tasks.forEach(i -> i.removeGroups(this));
        }
        if (tasks != null) {
            tasks.forEach(i -> i.addGroups(this));
        }
        this.tasks = tasks;
    }

    public Groups tasks(Set<Task> tasks) {
        this.setTasks(tasks);
        return this;
    }

    public Groups addTasks(Task task) {
        this.tasks.add(task);
        task.getGroups().add(this);
        return this;
    }

    public Groups removeTasks(Task task) {
