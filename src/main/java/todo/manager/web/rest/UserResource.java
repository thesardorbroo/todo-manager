...
import todo.manager.config.Constants;
import todo.manager.domain.User;
import todo.manager.repository.UserRepository;
import todo.manager.security.AuthoritiesConstants;
import todo.manager.service.MailService;
...
import todo.manager.web.rest.errors.EmailAlreadyUsedException;
import todo.manager.web.rest.errors.LoginAlreadyUsedException;

/**
 * REST controller for managing users.
 * <p>
 * This class accesses the {@link todo.manager.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
