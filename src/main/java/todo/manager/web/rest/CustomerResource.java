...
/**
 * REST controller for managing {@link todo.manager.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
    ...
    public ResponseDTO<CustomerDTO> createCustomer(@RequestBody CustomerDTO customerDTO) throws URISyntaxException {
    ...
    @GetMapping("/customers/by-login")
    public ResponseEntity<CustomerDTO> getCustomerByUserLogin(@RequestParam String login) {
        log.debug("REST request to get Customer : {}", login);
        Optional<CustomerDTO> optional = customerService.findOneByUserLogin(login);
